...
//   }
// });
en.add(e.world,[n])},es=["#B3DDC7","#F9E398","#EB7A53","#C1D8FE"],eu=["#D5B8F0","#C1D8FE","#F9E398","#EB7A53","#B3DDC7"],el=(()=>{let e=new er(".main-container-content .matter-js-container:visible",u.mainTags,es,{mouseDragging:!0});return e.init(),e.render(),e})(),ec=u.cases.map((e,t)=>{let n=`.case-${t}-container .matter-js-container`,r=new er(n,e.tags,eu,{flippable:!1});return r.init(),r.render(),r});let ef=/*@__PURE__*/r(l)(window).width(),ep=/*@__PURE__*/r(l)(window).height();/*@__PURE__*/r(l)(window).resize(()=>{(ef!==/*@__PURE__*/r(l)(window).width()||ep!==/*@__PURE__*/r(l)(window).height())&&(ef=/*@__PURE__*/r(l)(window).width(),ep=/*@__PURE__*/r(l)(window).height(),el.onWindowResizing(),ec.forEach(e=>e.render()))}),window.matchMedia("(max-width: 600px)").matches||(0===window.scrollY?G.addClass("description-container-margin").removeClass("description-container-margin-scrolled"):G.addClass("description-container-margin-scrolled").removeClass("description-container-margin"));//# sourceMappingURL=index.492f5e20.js.map

//# sourceMappingURL=index.492f5e20.js.map
