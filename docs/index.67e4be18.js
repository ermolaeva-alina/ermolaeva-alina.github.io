...
x!=b&&"constructor"in e&&"constructor"in t&&!("function"==typeof x&&x instanceof x&&"function"==typeof b&&b instanceof b)&&(v=!1)}return a.delete(e),a.delete(t),v}(e,t,n,i,o,a))}(e,t,n,i,nQ,o):e!=e&&t!=t)}/**
     ...
     *  else `false`.
     */function nK(e){return!(!oL(e)||eT&&eT in e)&&(oj(e)?eO:ec).test(iR(e))}/**
...
if(v){if(!ty(t,function(e,t){if(!tE(v,t)&&(h===e||o(h,e,n,i,a)))return v.push(t)})){d=!1;break}}else if(!(h===g||o(h,g,n,i,a))){d=!1;break}}return a.delete(e),a.delete(t),d}/**
     ...
     * // => [1]
     */var iE=rr(function(e,t){return oI(e)?nM(e,nD(t,1,oI,!0)):[]}),ij=rr(function(e,t){var n=iq(t);return oI(n)&&(n=r),oI(e)?nM(e,nD(t,1,oI,!0),it(n,2)):[]}),iD=rr(function(e,t){var n=iq(t);return oI(n)&&(n=r),oI(e)?nM(e,nD(t,1,oI,!0),r,n):[]});/**
   ...
   */function(e,t){for(var n=null==e?0:e.length;n--&&!1!==t(e[n],n,e););return e}:nR)(e,it(t,3))}/**
     ...
     * // => objects for [['fred'], ['barney', 'pebbles']]
     */var os=rj(function(e,t,n){e[n?0:1].push(t)},function(){return[[],[]]}),ou=rr(function(e,t){if(null==e)return[];var n=t.length;return n>1&&iv(e,t[0],t[1])?t=[]:n>2&&iv(t[0],t[1],t[2])&&(t=[t[0]]),n6(e,nD(t,1),[])}),ol=e4||function(){return e3.Date.now()};/**
...
oy.Cache=nd;/**
     ...
     * // => false
     */function oM(e){return null!=e&&oO(e.length)&&!oj(e)}/**
...
var t=nq(e);return t==h||t==g||"[object AsyncFunction]"==t||"[object Proxy]"==t}/**
   ...
   */function(e){for(var t,n=[];!(t=e.next()).done;)n.push(t.value);return n}(e[eJ]()));var t=iu(e);return(t==y?tz:t==w?tq:ad)(e)}/**
     ...
     * // => { 'a': 1, 'c': 3 }
     */var o2=rD(function(e,t){if(im(t)||oM(t)){rE(t,ai(t),e);return}for(var n in t)eI.call(t,n)&&nx(e,n,t[n])}),o5=rD(function(e,t){rE(t,ao(t),e)}),o3=rD(function(e,t,n,r){rE(t,ao(t),e,r)}),o9=rD(function(e,t,n,r){rE(t,ai(t),e,r)}),o4=r9(nA),o6=rr(function(e,t){e=eS(e);var n=-1,i=t.length,o=i>2?t[2]:r;for(o&&iv(t[0],t[1],o)&&(i=1);++n<i;)for(var a=t[n],s=ao(a),u=-1,l=s.length;++u<l;){var c=s[u],f=e[c];(f===r||oS(f,ek[c])&&!eI.call(e,c))&&(e[c]=a[c])}return e}),o8=rr(function(e){return e.push(r,r2),ta(as,r,e)});/**
     ...
     * // => { 'a': [{ 'b': 2, 'c': 3 }, { 'd': 4, 'e': 5 }] }
     */var aa=rD(function(e,t,n){n9(e,t,n)}),as=rD(function(e,t,n,r){n9(e,t,n,r)}),au=r9(function(e,t){var n={};if(null==e)return n;var r=!1;t=td(t,function(t){return t=rS(t,e),r||(r=t.length>1),t}),rE(e,r6(e),n),r&&(n=nC(n,7,r5));for(var i=t.length;i--;)rh(n,t[i]);return n}),al=r9(function(e,t){return null==e?{}:n8(e,t,function(t,n){return ae(e,n)})});/**
...
na.after=/*------------------------------------------------------------------------*//**
     ...
     * curried(3)(1, _)(2);
     * // => [1, 2, 3]
     */function e(t,n,i){n=i?r:n;var o=r0(t,16,r,r,r,r,r,n);return o.placeholder=e.placeholder,o},na.debounce=ov,na.defaults=o6,na.defaultsDeep=o8,na.defer=oh,na.delay=og,na.difference=iE,na.differenceBy=ij,na.differenceWith=iD,na.drop=/**
...
na.add=aH,na.attempt=aP,na.camelCase=av,na.capitalize=ah,na.ceil=a$,na.clamp=/*------------------------------------------------------------------------*//**
     ...
     * _.isFinite('3');
     * // => false
     */function(e){return"number"==typeof e&&tQ(e)},na.isFunction=oj,na.isInteger=oD,na.isLength=oO,na.isMap=oW,na.isMatch=/**
...
g.source=p,oE(g))throw g;return g},na.times=/**
     ...
     * // => ['foo', 'bar']
     */function(e,t,n){if((e=o1(e))&&(n||t===r))return tI(e);if(!e||!(t=rd(t)))return e;var i=t$(e),o=t$(t),a=tj(i,o),s=tD(i,o)+1;return rA(i,a,s).join("")},na.trimEnd=/**
...
x.x=y.position.x-y.positionPrev.x,x.y=y.position.y-y.positionPrev.y,b.x=m.position.x-m.positionPrev.x,b.y=m.position.y-m.positionPrev.y,y.angularVelocity=y.angle-y.anglePrev,m.angularVelocity=m.angle-m.anglePrev;s<C;s++){var I=P[s],R=I.vertex,T=R.x-y.position.x,E=R.y-y.position.y,j=R.x-m.position.x,D=R.y-m.position.y,O=x.x-E*y.angularVelocity,L=x.y+T*y.angularVelocity,V=b.x-D*m.angularVelocity,W=b.y+j*m.angularVelocity,z=O-V,F=L-W,U=_*z+w*F,q=S*z+A*F,H=h.separation+U,$=Math.min(H,1),N=($=H<0?0:$)*M;q<-N||q>N?(i=q>0?q:-q,(n=h.friction*(q>0?1:-1)*l)<-i?n=-i:n>i&&(n=i)):(n=q,i=d);// account for mass, inertia and contact offset
var G=T*w-E*_,X=j*w-D*_,Z=k/(B+y.inverseInertia*G*G+m.inverseInertia*X*X),Q=(1+h.restitution)*U*Z;// handle high velocity and resting collisions separately
...
var J=_*Q+S*n,ee=w*Q+A*n;y.isStatic||y.isSleeping||(y.positionPrev.x+=J*y.inverseMass,y.positionPrev.y+=ee*y.inverseMass,y.anglePrev+=(T*ee-E*J)*y.inverseInertia),m.isStatic||m.isSleeping||(m.positionPrev.x-=J*m.inverseMass,m.positionPrev.y-=ee*m.inverseMass,m.anglePrev-=(j*ee-D*J)*m.inverseInertia)}}}};/***/},/* 19 *//***/function(e,t,n){/**
