...
l=e.document?t(e,!0):function(e){if(!e.document)throw Error("jQuery requires a window with a document");return t(e)}:t(e);var c={},f={};f=new URL("arrow-dark.c266c189.svg",import.meta.url).toString();var p={};p=new URL("arrow-down.81662970.svg",import.meta.url).toString();var d={};d=new URL("arrow-right.c7563f9a.svg",import.meta.url).toString();var h={};h=new URL("arrow-up.ac354ea9.svg",import.meta.url).toString();var v={};v=new URL("arrow.8397d492.svg",import.meta.url).toString();var g={};g=new URL("avatar.2c8b6978.png",import.meta.url).toString();var y={};y=new URL("case-1.d3499120.png",import.meta.url).toString();var m={};m=new URL("case-2.23430c2d.png",import.meta.url).toString();var x={};x=new URL("case-3.f165a2c5.png",import.meta.url).toString();var b={};b=new URL("case-studies-vector.4e4fe3e1.svg",import.meta.url).toString();var w={};w=new URL("check.b9e1fb0c.svg",import.meta.url).toString();var _={};_=new URL("copy.30df4a9b.svg",import.meta.url).toString();var S={};S=new URL("emotional-vector.52981a5a.svg",import.meta.url).toString();var A={};A=new URL("flag.c9cddf54.png",import.meta.url).toString();var C={};C=new URL("footer-orange-vector.1193adbe.svg",import.meta.url).toString();var k={};k=new URL("footer-purple-vector.ac11826b.svg",import.meta.url).toString();var T={};T=new URL("hand.519e237c.svg",import.meta.url).toString();var E={};E=new URL("heart.a80f852b.svg",import.meta.url).toString();var P={};P=new URL("human-friendly-vector.25a740a4.svg",import.meta.url).toString();var j={};j=new URL("new.04fc448e.svg",import.meta.url).toString();var M={};M=new URL("plane.332ad5c1.svg",import.meta.url).toString();var D={};D=new URL("ui.dd428ae2.svg",import.meta.url).toString();c={"arrow-dark.svg":f,"arrow-down.svg":p,"arrow-right.svg":d,"arrow-up.svg":h,"arrow.svg":v,"avatar.png":g,"case-1.png":y,"case-2.png":m,"case-3.png":x,"case-studies-vector.svg":b,"check.svg":w,"copy.svg":_,"emotional-vector.svg":S,"flag.png":A,"footer-orange-vector.svg":C,"footer-purple-vector.svg":k,"hand.svg":T,"heart.svg":E,"human-friendly-vector.svg":P,"new.svg":j,"plane.svg":M,"ui.svg":D,"ux.svg":new URL("ux.1c719840.svg",import.meta.url).toString()};const R=new URL(d),I=(e,t)=>{let n=new URL(/*@__PURE__*/r(c)[t.imageName],"file:///src/js/cases.js");return`
    <section>
  ...
  `},B=/*@__PURE__*/r(l)("#cases-section");u.cases.forEach((e,t)=>{B.append(I(t,e)),/*@__PURE__*/r(l)(`#full-case-button-${t}`).on("click",()=>window.open(e.link))});const L=/*@__PURE__*/r(l)(".copied-popup-flying-container");let O=!1;async function H(){if(await navigator.clipboard.writeText("alinaermolaeva044@gmail.com"),O)return;O=!0;let e=N();L.css("display","block").addClass(e.show).removeClass(e.hide),setTimeout(()=>{L.addClass(e.hide).removeClass(e.show)},3e3)// Элемент начнет исчезать через 3 секунд
,L.on("animationend",()=>{L.hasClass(e.hide)&&(L.css("display","none"),O=!1),L.removeClass(e.hide)})}const N=()=>window.matchMedia("(max-width: 600px)").matches?{show:"animate__fadeInDown",hide:"animate__fadeOutUp"}:{show:"animate__fadeInUp",hide:"animate__fadeOutDown"},q=()=>{if(0===window.scrollY&&!window.matchMedia("(max-width: 600px)").matches){let e=/*@__PURE__*/r(l)(".floating-footer-container").height(),t=Number.parseInt(/*@__PURE__*/r(l)(".main-footer-section").css("margin-top").replace("px",""));return e-t}return 0},F=()=>{let e=/*@__PURE__*/r(l)("#description-section");return e.position().top+e.outerHeight()},W=()=>{let e=/*@__PURE__*/r(l)(".floating-header-container > *").not((e,t)=>"none"===/*@__PURE__*/r(l)(t).css("display"));return Number.parseInt(e.css("padding-bottom").replace("px",""))},U=()=>{let e=q(),t=F(),n=W(),i=/*@__PURE__*/r(l)(".floating-header-container").height();return t-e-(i-n)},V=()=>/*@__PURE__*/r(l)(".footer-links").position().top,$=()=>/*@__PURE__*/r(l)("footer").position().top,z=/*@__PURE__*/r(l)(".floating-footer-container"),G=/*@__PURE__*/r(l)(".description-container");let X=window.scrollY;const Y=()=>{if(window.matchMedia("(max-width: 600px)").matches)return;let e=0===window.scrollY;e?G.addClass("description-container-margin").removeClass("description-container-margin-scrolled"):G.addClass("description-container-margin-scrolled").removeClass("description-container-margin");let t=window.scrollY<X,n=window.scrollY+window.innerHeight<V();e||t&&n?z.addClass("animate__slideInUp").removeClass("animate__slideOutDown"):z.addClass("animate__slideOutDown").removeClass("animate__slideInUp"),X=window.scrollY},J=()=>{let e=/*@__PURE__*/r(l)(".floating-header-container > *").not((e,t)=>"none"===/*@__PURE__*/r(l)(t).css("display")).find(".menu-buttons").first(),t=e.children(".home").first(),n=e.children(".work").first(),i=e.children(".contacts").first();window.scrollY<U()-5?(t.addClass("selected-menu-button"),n.removeClass("selected-menu-button"),i.removeClass("selected-menu-button")):window.innerHeight+window.scrollY<$()?(t.removeClass("selected-menu-button"),n.addClass("selected-menu-button"),i.removeClass("selected-menu-button")):(t.removeClass("selected-menu-button"),n.removeClass("selected-menu-button"),i.addClass("selected-menu-button"))};/*@__PURE__*/r(l)(".email-container").on("click",async()=>H()),/*@__PURE__*/r(l)("#up-button").on("click",()=>window.scrollTo({top:0,behavior:"smooth"})),/*@__PURE__*/r(l)("#explore-cases-button").on("click",()=>window.scrollTo({top:U(),behavior:"smooth"})),/*@__PURE__*/r(l)(".menu-buttons > .home").on("click",()=>window.scrollTo({top:0,behavior:"smooth"})),/*@__PURE__*/r(l)(".menu-buttons > .work").on("click",()=>window.scrollTo({top:U(),behavior:"smooth"})),/*@__PURE__*/r(l)(".menu-buttons > .contacts").on("click",()=>window.scrollTo({top:document.body.offsetHeight,behavior:"smooth"})),/*@__PURE__*/r(l)(window).scroll(()=>{Y(),J()}),/*@__PURE__*/r(l)(window).on("resize",()=>Y()),/*@__PURE__*/r(l)(".cv-block").on("click",()=>window.open(u.cv)),/*@__PURE__*/r(l)(".cv-button").on("click",()=>window.open(u.cv)),/*@__PURE__*/r(l)(".behance").on("click",()=>window.open(u.behance)),/*@__PURE__*/r(l)(".linkedin").on("click",()=>window.open(u.linkedin)),/*@__PURE__*/r(l)(".telegram").on("click",()=>window.open(u.telegram));var Q={};Q=/******/function(e){/******/// The module cache
...
*/var r={};e.exports=r;var i=n(6);n(0),/**
     ...
     */r.create=i.create,r.add=i.add,r.remove=i.remove,r.clear=i.clear,r.addComposite=i.addComposite,r.addBody=i.addBody,r.addConstraint=i.addConstraint;/***/}]);const Z=(e,t)=>(e=Math.ceil(e),Math.floor(Math.random()*((t=Math.floor(t))-e+1))+e);var K=a("f1q41");const ee=/*@__PURE__*/r(Q).Engine,et=/*@__PURE__*/r(Q).Bodies,en=/*@__PURE__*/r(Q).Composite;class er{#e=500;constructor(e,t,n,{flippable:i=!0,mouseDragging:o=!1,debugPhysics:a=!1}){this.containerSelector=e,this.$matterJsContainer=/*@__PURE__*/r(l)(e),this.tagTexts=t,this.tagColors=n,this.engine=null,this.tags=[],this.debugPhysics=a,this.mouseDragging=o,this.flippable=i}init(){this.engine=ee.create({positionIterations:10,velocityIterations:10,constraintIterations:10,timing:{timeScale:.8}});let{containerWidth:e,containerHeight:t}=this.#t();this.debugPhysics&&(this.matterRender=/*@__PURE__*/r(Q).Render.create({element:this.$matterJsContainer.get(0),engine:this.engine,options:{width:e,height:t,wireframes:!0}}),/*@__PURE__*/r(Q).Render.run(this.matterRender))}#t(){let e=this.$matterJsContainer.width(),t=this.$matterJsContainer.height(),n=t+this.#e;return this.tags=this.tagTexts.map((n,r)=>{let i=Z(.2*e,.8*e),o=Z(.2*t-this.#e,.8*t),a=this.tagColors[r%this.tagColors.length],s=eo(i,o,n,a,this.$matterJsContainer,this.mouseDragging,this.flippable);return en.add(this.engine.world,s.body),s}),this.mouseDragging&&ea(this.engine,this.$matterJsContainer),en.add(this.engine.world,ei(e,t,n,this.#e)),{containerWidth:e,containerHeight:t}}removeObjects(){en.clear(this.engine.world,!1),this.tags.forEach(e=>e.elem.remove()),this.tags=[]}render(){this.tags.forEach(e=>e.render());let e=1e3/60/3;for(let t=0;t<3;t+=1)ee.update(this.engine,e);requestAnimationFrame(this.render.bind(this))}#n=/*@__PURE__*/r(K).throttle(()=>{this.removeObjects(),this.$matterJsContainer=/*@__PURE__*/r(l)(this.containerSelector),this.#t(),this.debugPhysics&&(this.matterRender.canvas.height=this.$matterJsContainer.height(),this.matterRender.canvas.width=this.$matterJsContainer.width())},1e3);onWindowResizing(){this.#n()}}const ei=(e,t,n,r)=>[et.rectangle(e/2,-r,e,1,{isStatic:!0}),et.rectangle(e/2,t,e,1,{isStatic:!0}),et.rectangle(0,(t-r)/2,1,n,{isStatic:!0}),et.rectangle(e,(t-r)/2,1,n,{isStatic:!0})// right
    ],eo=(e,t,n,i,o,a,s)=>{let u=Z(0,1e5);o.append(`<div id="tag${u}" class="interactive-tag tag-24">${n}</div>`);let c=/*@__PURE__*/r(l)("#tag"+u),f=c.height(),p=c.outerWidth();c.css({width:p+"px",padding:0,"background-color":i,cursor:a?"pointer":"default"});let d=Number.parseInt(c.css("border-radius").replace("px","")),h=2*Number.parseInt(c.css("border").replace(/px.*/,""));return{w:p+h,h:f+h,body:et.rectangle(e,t,p+h,f+h,{chamfer:{radius:d}}),elem:document.querySelector("#tag"+u),render(){let e=this.body.angle;!s&&(e<-1&&/*@__PURE__*/r(Q).Body.setAngle(this.body,-1),e>1&&/*@__PURE__*/r(Q).Body.setAngle(this.body,1));let{x:t,y:n}=this.body.position,i=n-this.h/2;this.elem.style.top=`${i}px`;let o=t-this.w/2;this.elem.style.left=`${o}px`,this.elem.style.transform=`rotate(${e}rad)`}}},ea=(e,t)=>{let n=/*@__PURE__*/r(Q).MouseConstraint.create(e,{element:t.get(0)}),i=n.mouse;i.element.removeEventListener("mousewheel",i.mousewheel),i.element.removeEventListener("DOMMouseScroll",i.mousewheel),// mouse.element.removeEventListener('touchstart', mouse.mousedown);
...
//   }
// });
en.add(e.world,[n])},es=["#B3DDC7","#F9E398","#EB7A53","#C1D8FE"],eu=["#D5B8F0","#C1D8FE","#F9E398","#EB7A53","#B3DDC7"],el=(()=>{let e=new er(".main-container-content .matter-js-container:visible",u.mainTags,es,{mouseDragging:!0});return e.init(),e.render(),e})(),ec=u.cases.map((e,t)=>{let n=`.case-${t}-container .matter-js-container`,r=new er(n,e.tags,eu,{flippable:!1});return r.init(),r.render(),r});let ef=/*@__PURE__*/r(l)(window).width(),ep=/*@__PURE__*/r(l)(window).height();/*@__PURE__*/r(l)(window).resize(()=>{(ef!==/*@__PURE__*/r(l)(window).width()||ep!==/*@__PURE__*/r(l)(window).height())&&(ef=/*@__PURE__*/r(l)(window).width(),ep=/*@__PURE__*/r(l)(window).height(),el.onWindowResizing(),ec.forEach(e=>e.onWindowResizing()))}),window.matchMedia("(max-width: 600px)").matches||(0===window.scrollY?G.addClass("description-container-margin").removeClass("description-container-margin-scrolled"):G.addClass("description-container-margin-scrolled").removeClass("description-container-margin"));//# sourceMappingURL=index.c7a66eba.js.map

//# sourceMappingURL=index.c7a66eba.js.map
