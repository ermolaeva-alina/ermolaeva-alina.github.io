...
*/var r={};e.exports=r;var i=n(6);n(0),/**
     ...
     */r.create=i.create,r.add=i.add,r.remove=i.remove,r.clear=i.clear,r.addComposite=i.addComposite,r.addBody=i.addBody,r.addConstraint=i.addConstraint;/***/}]);const _=e=>Math.round(100*e)/100,S=(e,t)=>(e=Math.ceil(e),Math.floor(Math.random()*((t=Math.floor(t))-e+1))+e);var A=a("f1q41");const C=/*@__PURE__*/r(w).Engine,T=/*@__PURE__*/r(w).Bodies,k=/*@__PURE__*/r(w).Composite;class P{#e=500;constructor(e,t,n,i=!1,o=!1){this.containerSelector=e,this.$canvasContainer=/*@__PURE__*/r(s)(e),this.tagTexts=t,this.tagColors=n,this.engine=null,this.initialized=!1,this.tags=[],this.debugPhysics=o,this.mouseDragging=i}init(){this.engine=C.create({// positionIterations: 10,
// velocityIterations: 10,
timing:{timeScale:.8}});let{containerWidth:e,containerHeight:t}=this.#t();this.debugPhysics&&(this.render=/*@__PURE__*/r(w).Render.create({element:this.$canvasContainer.get(0),engine:this.engine,options:{width:e,height:t,wireframes:!0}}),/*@__PURE__*/r(w).Render.run(render)),this.initialized=!0}#t(){let e=this.$canvasContainer.width(),t=this.$canvasContainer.height(),n=t+this.#e;return this.tags=this.tagTexts.map((n,r)=>{let i=S(.2*e,.8*e),o=S(.2*t-this.#e,.8*t),a=this.tagColors[r%this.tagColors.length],s=j(i,o,n,a,this.$canvasContainer,this.mouseDragging);return k.add(this.engine.world,s.body),s}),this.mouseDragging&&M(this.engine,this.$canvasContainer),k.add(this.engine.world,E(e,t,n,this.#e)),{containerWidth:e,containerHeight:t}}removeObjects(){k.clear(this.engine.world),this.tags.forEach(e=>e.elem.remove()),this.tags=[]}render(){this.initialized||this.init(),this.tags.forEach(e=>e.render()),C.update(this.engine),requestAnimationFrame(this.render.bind(this))}#n=/*@__PURE__*/r(A).throttle(()=>{this.removeObjects(),this.$canvasContainer=/*@__PURE__*/r(s)(this.containerSelector),this.#t(),this.debugPhysics&&(this.render.canvas.height=this.$canvasContainer.height(),this.render.canvas.width=this.$canvasContainer.width())},1e3);onWindowResizing(){this.#n()}}const E=(e,t,n,r)=>[T.rectangle(e/2,-r,e,1,{isStatic:!0}),T.rectangle(e/2,t,e,1,{isStatic:!0}),T.rectangle(0,(t-r)/2,1,n,{isStatic:!0}),T.rectangle(e,(t-r)/2,1,n,{isStatic:!0})// right
    ],j=(e,t,n,i,o,a)=>{let u=S(0,1e5);o.append(`<div id="tag${u}" class="interactive-tag tag-24">${n}</div>`);let l=/*@__PURE__*/r(s)("#tag"+u),c=l.height(),f=l.outerWidth();l.css({width:f+"px",padding:0,"background-color":i,cursor:a?"pointer":"default"});let p=Number.parseInt(l.css("border-radius").replace("px","")),d=2*Number.parseInt(l.css("border").replace(/px.*/,""));return{w:f+d,h:c+d,body:T.rectangle(e,t,f+d,c+d,{chamfer:{radius:p}}),elem:document.querySelector("#tag"+u),prevX:_(e),prevY:_(t),render(){let{x:e,y:t}=this.body.position,n=_(e),r=_(t);if(this.prevX===n&&this.prevY===r)return;let i=r-this.h/2;this.elem.style.top=`${i}px`;let o=n-this.w/2;this.elem.style.left=`${o}px`,this.elem.style.transform=`rotate(${this.body.angle}rad)`,this.prevX=n,this.prevY=r}}},M=(e,t)=>{let n=/*@__PURE__*/r(w).MouseConstraint.create(e,{element:t.get(0)}),i=n.mouse;i.element.removeEventListener("mousewheel",i.mousewheel),i.element.removeEventListener("DOMMouseScroll",i.mousewheel),i.element.removeEventListener("touchstart",i.mousedown),i.element.removeEventListener("touchmove",i.mousemove),i.element.removeEventListener("touchend",i.mouseup),i.element.addEventListener("touchstart",i.mousedown,{passive:!0}),i.element.addEventListener("touchmove",e=>{n.body&&i.mousemove(e)}),i.element.addEventListener("touchend",e=>{n.body&&i.mouseup(e)}),k.add(e.world,[n])},D=(()=>{let e=new P(".main-container-content .canvas-container:visible",["JTBD","User & Market Research","Usability testing","Accessibility","CJM","Qualitative research","UX design","Wireframing","UX research","Quantitative research","Design systems","Problem solving","User centred design","User-Centered Design","Prototyping","Interaction design"],["#B3DDC7","#F9E398","#EB7A53","#C1D8FE"],!0,!1);return e.render(),e})(),I=["#D5B8F0","#C1D8FE","#F9E398","#EB7A53","#B3DDC7"],B=(()=>{let e=new P(".case-1-container .canvas-container",["Design system","UI design","B2B","Qualitative research","Usability testing","2022"],I);return e.render(),e})(),R=(()=>{let e=new P(".case-2-container .canvas-container",["Design system","UI design","B2B","Qualitative research","Usability testing","2022"],I);return e.render(),e})(),L=(()=>{let e=new P(".case-3-container .canvas-container",["Design system","UI design","B2B","Qualitative research","Usability testing","2022"],I);return e.render(),e})();let O=/*@__PURE__*/r(s)(window).width(),q=/*@__PURE__*/r(s)(window).height();/*@__PURE__*/r(s)(window).resize(()=>{(O!==/*@__PURE__*/r(s)(window).width()||q!==/*@__PURE__*/r(s)(window).height())&&(O=/*@__PURE__*/r(s)(window).width(),q=/*@__PURE__*/r(s)(window).height(),D.onWindowResizing(),B.onWindowResizing(),R.onWindowResizing(),L.onWindowResizing())}),window.matchMedia("(max-width: 600px)").matches||(0===window.scrollY?y.addClass("description-container-margin").removeClass("description-container-margin-scrolled"):y.addClass("description-container-margin-scrolled").removeClass("description-container-margin"));//# sourceMappingURL=index.4264faa4.js.map

//# sourceMappingURL=index.4264faa4.js.map
