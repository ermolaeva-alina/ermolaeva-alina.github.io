...
*/var r={};e.exports=r;var i=n(6);n(0),/**
     ...
     */r.create=i.create,r.add=i.add,r.remove=i.remove,r.clear=i.clear,r.addComposite=i.addComposite,r.addBody=i.addBody,r.addConstraint=i.addConstraint;/***/}]);const Q=(e,t)=>(e=Math.ceil(e),Math.floor(Math.random()*((t=Math.floor(t))-e+1))+e);var Z=a("f1q41");const K=/*@__PURE__*/r(J).Engine,ee=/*@__PURE__*/r(J).Bodies,et=/*@__PURE__*/r(J).Composite;class en{#e=500;constructor(e,t,n,{flippable:i=!0,mouseDragging:o=!1,debugPhysics:a=!1}){this.containerSelector=e,this.$matterJsContainer=/*@__PURE__*/r(l)(e),this.tagTexts=t,this.tagColors=n,this.engine=null,this.tags=[],this.debugPhysics=a,this.mouseDragging=o,this.flippable=i}init(){this.engine=K.create({positionIterations:10,velocityIterations:10,constraintIterations:10,timing:{timeScale:.8}});let{containerWidth:e,containerHeight:t}=this.#t();this.debugPhysics&&(this.matterRender=/*@__PURE__*/r(J).Render.create({element:this.$matterJsContainer.get(0),engine:this.engine,options:{width:e,height:t,wireframes:!0}}),/*@__PURE__*/r(J).Render.run(this.matterRender))}#t(){let e=this.$matterJsContainer.width(),t=this.$matterJsContainer.height(),n=t+this.#e;return this.tags=this.tagTexts.map((n,r)=>{let i=Q(.2*e,.8*e),o=Q(.2*t-this.#e,.8*t),a=this.tagColors[r%this.tagColors.length],s=ei(i,o,n,a,this.$matterJsContainer,this.mouseDragging,this.flippable);return et.add(this.engine.world,s.body),s}),this.mouseDragging&&eo(this.engine,this.$matterJsContainer),et.add(this.engine.world,er(e,t,n,this.#e)),{containerWidth:e,containerHeight:t}}removeObjects(){et.clear(this.engine.world,!1),this.tags.forEach(e=>e.elem.remove()),this.tags=[]}render(){this.tags.forEach(e=>e.render());let e=1e3/60/3;for(let t=0;t<3;t+=1)K.update(this.engine,e);requestAnimationFrame(this.render.bind(this))}#n=/*@__PURE__*/r(Z).throttle(()=>{this.removeObjects(),this.$matterJsContainer=/*@__PURE__*/r(l)(this.containerSelector),this.#t(),this.debugPhysics&&(this.matterRender.canvas.height=this.$matterJsContainer.height(),this.matterRender.canvas.width=this.$matterJsContainer.width())},1e3);onWindowResizing(){this.#n()}}const er=(e,t,n,r)=>[ee.rectangle(e/2,-r,e,1,{isStatic:!0}),ee.rectangle(e/2,t,e,1,{isStatic:!0}),ee.rectangle(0,(t-r)/2,1,n,{isStatic:!0}),ee.rectangle(e,(t-r)/2,1,n,{isStatic:!0})// right
    ],ei=(e,t,n,i,o,a,s)=>{let u=Q(0,1e5);o.append(`<div id="tag${u}" class="interactive-tag tag-24">${n}</div>`);let c=/*@__PURE__*/r(l)("#tag"+u),f=c.height(),p=c.outerWidth();c.css({width:p+"px",padding:0,"background-color":i,cursor:a?"pointer":"default"});let d=Number.parseInt(c.css("border-radius").replace("px","")),h=2*Number.parseInt(c.css("border").replace(/px.*/,""));return{w:p+h,h:f+h,body:ee.rectangle(e,t,p+h,f+h,{chamfer:{radius:d}}),elem:document.querySelector("#tag"+u),render(){let e=this.body.angle;!s&&(e<-1&&/*@__PURE__*/r(J).Body.setAngle(this.body,-1),e>1&&/*@__PURE__*/r(J).Body.setAngle(this.body,1));let{x:t,y:n}=this.body.position,i=n-this.h/2;this.elem.style.top=`${i}px`;let o=t-this.w/2;this.elem.style.left=`${o}px`,this.elem.style.transform=`rotate(${e}rad)`}}},eo=(e,t)=>{let n=/*@__PURE__*/r(J).MouseConstraint.create(e,{element:t.get(0)}),i=n.mouse;i.element.removeEventListener("mousewheel",i.mousewheel),i.element.removeEventListener("DOMMouseScroll",i.mousewheel),// mouse.element.removeEventListener('touchstart', mouse.mousedown);
...
//   }
// });
et.add(e.world,[n])},ea=["#B3DDC7","#F9E398","#EB7A53","#C1D8FE"],es=["#D5B8F0","#C1D8FE","#F9E398","#EB7A53","#B3DDC7"],eu=(()=>{let e=new en(".main-container-content .matter-js-container:visible",u.mainTags,ea,{mouseDragging:!0});return e.init(),e.render(),e})(),el=u.cases.map((e,t)=>{let n=`.case-${t}-container .matter-js-container`,r=new en(n,e.tags,es,{flippable:!1});return r.init(),r.render(),r});let ec=/*@__PURE__*/r(l)(window).width(),ef=/*@__PURE__*/r(l)(window).height();/*@__PURE__*/r(l)(window).resize(()=>{(ec!==/*@__PURE__*/r(l)(window).width()||ef!==/*@__PURE__*/r(l)(window).height())&&(ec=/*@__PURE__*/r(l)(window).width(),ef=/*@__PURE__*/r(l)(window).height(),eu.onWindowResizing(),el.forEach(e=>e.render()))}),window.matchMedia("(max-width: 600px)").matches||(0===window.scrollY?z.addClass("description-container-margin").removeClass("description-container-margin-scrolled"):z.addClass("description-container-margin-scrolled").removeClass("description-container-margin"));//# sourceMappingURL=index.e1a51932.js.map

//# sourceMappingURL=index.e1a51932.js.map
