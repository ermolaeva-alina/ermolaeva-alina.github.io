...
ny.prototype.clear=/**
     ...
     */function nJ(e,t,n){t=rC(t,e);var i=null==(e=iS(e,t))?e:e[iD(iU(t))];return null==i?r:ta(i,e,n)}/**
...
return oN(r)?r:n}}/**
   ...
   */function(e,t){for(var n=e.length,r=0;n--;)e[n]===t&&++r;return r}(x,w);if(i&&(x=rD(x,i,o,h)),a&&(x=rI(x,a,s,h)),m-=_,h&&m<c){var S=tF(x,w);return rZ(e,t,rU,y.placeholder,n,x,S,u,l,c-m)}var A=p?n:this,C=d?A[e]:e;return m=x.length,u?x=/**
...
t=oZ(t),n===r?(n=t,t=0):n=oZ(n),i=i===r?t<n?1:-1:oZ(i),/**
     ...
     * @param {number} [arity] The arity of `func`.
     * @returns {Function} Returns the new wrapped function.
     */function rZ(e,t,n,i,o,a,s,u,l,c){var f=8&t,p=f?s:r,d=f?r:s,h=f?a:r,v=f?r:a;t|=f?32:64,4&(t&=~(f?64:32))||(t&=-4);var g=[e,t,o,h,p,v,d,u,l,c],y=n.apply(r,g);return im(e)&&iC(y,g),y.placeholder=i,iP(y,e,t)}/**
...
if(h){if(!ty(t,function(e,t){if(!tI(h,t)&&(v===e||o(v,e,n,i,a)))return h.push(t)})){d=!1;break}}else if(!(v===g||o(v,g,n,i,a))){d=!1;break}}return a.delete(e),a.delete(t),d}/**
   ...
   */function(e,t){for(var n=null==e?0:e.length;n--&&!1!==t(e[n],n,e););return e}:nI)(e,ii(t,3))}/**
     ...
     * // => { '3': ['one', 'two'], '5': ['three'] }
     */var oo=rL(function(e,t,n){eD.call(e,n)?e[n].push(t):nC(e,n,[t])}),oa=ro(function(e,t,n){var r=-1,i="function"==typeof t,o=oM(e)?em(e.length):[];return nD(e,function(e){o[++r]=i?ta(t,e,n):nJ(e,t,n)}),o}),os=rL(function(e,t,n){nC(e,n,t)});/**
...
ox.Cache=nv;/**
     ...
     * _.gt(1, 3);
     * // => false
     */var oT=rQ(n$),ok=rQ(function(e,t){return e>=t}),oP=nQ(function(){return arguments}())?nQ:function(e){return oH(e)&&eD.call(e,"callee")&&!eX.call(e,"callee")},oE=em.isArray,oj=te?tM(te):/**
...
nu.after=/*------------------------------------------------------------------------*//**
     ...
     */function(e,t,n){var r=!0,o=!0;if("function"!=typeof e)throw new eT(i);return oN(n)&&(r="leading"in n?!!n.leading:r,o="trailing"in n?!!n.trailing:o),og(e,t,{leading:r,maxWait:t,trailing:o})},nu.thru=i8,nu.toArray=oQ,nu.toPairs=ad,nu.toPairsIn=ah,nu.toPath=/**
...
return oF(e)&&e!=+e},nu.isNative=/**
   ...
   */function(e,t,n){for(var r=n+1;r--&&e[r]!==t;);return r}(e,t,o):tb(e,tS,o,!0)},nu.lowerCase=ab,nu.lowerFirst=aw,nu.lt=oY,nu.lte=oJ,nu.max=/**
     ...
     * // => 'default'
     */function(e,t,n){t=rC(t,e);var i=-1,o=t.length;for(o||(o=1,e=r);++i<o;){var a=null==e?r:e[iD(t[i])];a===r&&(i=o,a=n),e=oL(a)?a.call(e):a}return e},nu.round=aQ,nu.runInContext=e,nu.sample=/**
     ...
     * // => true
     */function(e,t,n){return e=o5(e),n=null==n?0:nk(oK(n),0,e.length),t=rv(t),e.slice(n,n+t.length)==t},nu.subtract=aZ,nu.sum=/**
...
var i=nu.templateSettings;n&&ig(e,t,n)&&(t=r),e=o5(e),t=o9({},t,i,r5);var o,a,s=o9({},t.imports,i.imports,r5),u=aa(s),l=tD(s,u),c=0,f=t.interpolate||eh,p="__p += '",d=eA((t.escape||eh).source+"|"+f.source+"|"+(f===$?ea:eh).source+"|"+(t.evaluate||eh).source+"|$","g"),h="//# sourceURL="+(eD.call(t,"sourceURL")?(t.sourceURL+"").replace(/\s/g," "):"lodash.templateSources["+ ++eJ+"]")+"\n";e.replace(d,function(t,n,r,i,s,u){// The JS engine embedded in Adobe products needs `match` returned in
...
g.source=p,oR(g))throw g;return g},nu.times=/**
     ...
     * // => 'abc-_-'
     */function(e,t,n){if((e=o5(e))&&(n||t===r))return e.replace(Z,"");if(!e||!(t=rv(t)))return e;var i=tU(e),o=tB(i,tU(t));return rT(i,o).join("")},nu.truncate=/**
...
var X=D*_-I*w,G=B*_-R*w,Y=k/(P+y.inverseInertia*X*X+m.inverseInertia*G*G),J=(1+v.restitution)*F*Y;// handle high velocity and resting collisions separately
...
var K=w*J+S*n,ee=_*J+A*n;y.isStatic||y.isSleeping||(y.positionPrev.x+=K*y.inverseMass,y.positionPrev.y+=ee*y.inverseMass,y.anglePrev+=(D*ee-I*K)*y.inverseInertia),m.isStatic||m.isSleeping||(m.positionPrev.x-=K*m.inverseMass,m.positionPrev.y-=ee*m.inverseMass,m.anglePrev-=(B*ee-R*K)*m.inverseInertia)}}}};/***/},/* 19 *//***/function(e,t,n){/**
