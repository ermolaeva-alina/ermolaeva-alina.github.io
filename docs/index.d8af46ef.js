...
s=e.document?t(e,!0):function(e){if(!e.document)throw Error("jQuery requires a window with a document");return t(e)}:t(e);const u=/*@__PURE__*/r(s)(".copied-popup-flying-container");let l=!1;async function c(){if(await navigator.clipboard.writeText("alinaermolaeva044@gmail.com"),l)return;l=!0;let e=f();u.css("display","block").addClass(e.show).removeClass(e.hide),setTimeout(()=>{u.addClass(e.hide).removeClass(e.show)},3e3),u.on("animationend",()=>{u.hasClass(e.hide)&&(u.css("display","none"),l=!1),u.removeClass(e.hide)})}const f=()=>window.matchMedia("(max-width: 600px)").matches?{show:"animate__fadeInDown",hide:"animate__fadeOutUp"}:{show:"animate__fadeInUp",hide:"animate__fadeOutDown"},p=()=>{if(0===window.scrollY&&!window.matchMedia("(max-width: 600px)").matches){let e=/*@__PURE__*/r(s)(".floating-footer-container").height(),t=Number.parseInt(/*@__PURE__*/r(s)(".main-footer-section").css("margin-top").replace("px",""));return e-t}return 0},d=()=>{let e=/*@__PURE__*/r(s)("#description-section");return e.position().top+e.outerHeight()},h=()=>{let e=/*@__PURE__*/r(s)(".floating-header-container > *").not((e,t)=>"none"===/*@__PURE__*/r(s)(t).css("display"));return Number.parseInt(e.css("padding-bottom").replace("px",""))},v=()=>{let e=p(),t=d(),n=h(),i=/*@__PURE__*/r(s)(".floating-header-container").height();return t-e-(i-n)},g=()=>/*@__PURE__*/r(s)(".footer-links").position().top,y=()=>/*@__PURE__*/r(s)("footer").position().top,m=/*@__PURE__*/r(s)(".floating-footer-container"),x=/*@__PURE__*/r(s)(".description-container");let b=window.scrollY;const w=()=>{if(window.matchMedia("(max-width: 600px)").matches)return;let e=0===window.scrollY;e?x.addClass("description-container-margin").removeClass("description-container-margin-scrolled"):x.addClass("description-container-margin-scrolled").removeClass("description-container-margin");let t=window.scrollY<b,n=window.scrollY+window.innerHeight<g();e||t&&n?m.addClass("animate__slideInUp").removeClass("animate__slideOutDown"):m.addClass("animate__slideOutDown").removeClass("animate__slideInUp"),b=window.scrollY},_=()=>{let e=/*@__PURE__*/r(s)(".floating-header-container > *").not((e,t)=>"none"===/*@__PURE__*/r(s)(t).css("display")).find(".menu-buttons").first(),t=e.children(".home").first(),n=e.children(".work").first(),i=e.children(".contacts").first();window.scrollY<v()-5?(t.addClass("selected-menu-button"),n.removeClass("selected-menu-button"),i.removeClass("selected-menu-button")):window.innerHeight+window.scrollY<y()?(t.removeClass("selected-menu-button"),n.addClass("selected-menu-button"),i.removeClass("selected-menu-button")):(t.removeClass("selected-menu-button"),n.removeClass("selected-menu-button"),i.addClass("selected-menu-button"))};/*@__PURE__*/r(s)(".email-container").on("click",async()=>c()),/*@__PURE__*/r(s)("#up-button").on("click",()=>window.scrollTo({top:0,behavior:"smooth"})),/*@__PURE__*/r(s)("#explore-cases-button").on("click",()=>window.scrollTo({top:v(),behavior:"smooth"})),/*@__PURE__*/r(s)(".menu-buttons > .home").on("click",()=>window.scrollTo({top:0,behavior:"smooth"})),/*@__PURE__*/r(s)(".menu-buttons > .work").on("click",()=>window.scrollTo({top:v(),behavior:"smooth"})),/*@__PURE__*/r(s)(".menu-buttons > .contacts").on("click",()=>window.scrollTo({top:document.body.offsetHeight,behavior:"smooth"})),/*@__PURE__*/r(s)(window).scroll(()=>{w(),_()}),/*@__PURE__*/r(s)(window).on("resize",()=>w());var S={};S=/******/function(e){/******/// The module cache
...
*/var r={};e.exports=r;var i=n(6);n(0),/**
     ...
     */r.create=i.create,r.add=i.add,r.remove=i.remove,r.clear=i.clear,r.addComposite=i.addComposite,r.addBody=i.addBody,r.addConstraint=i.addConstraint;/***/}]);const C=e=>Math.round(100*e)/100,A=(e,t)=>(e=Math.ceil(e),Math.floor(Math.random()*((t=Math.floor(t))-e+1))+e);var k=a("f1q41");const T=/*@__PURE__*/r(S).Engine,P=/*@__PURE__*/r(S).Bodies,E=/*@__PURE__*/r(S).Composite;class j{#e=500;constructor(e,t,n,i=!1,o=!1){this.containerSelector=e,this.$matterJsContainer=/*@__PURE__*/r(s)(e),this.tagTexts=t,this.tagColors=n,this.engine=null,this.initialized=!1,this.tags=[],this.debugPhysics=o,this.mouseDragging=i}init(){this.engine=T.create({positionIterations:10,velocityIterations:10,constraintIterations:10,timing:{timeScale:.8}});let{containerWidth:e,containerHeight:t}=this.#t();this.debugPhysics&&(this.matterRender=/*@__PURE__*/r(S).Render.create({element:this.$matterJsContainer.get(0),engine:this.engine,options:{width:e,height:t,wireframes:!0}}),/*@__PURE__*/r(S).Render.run(this.matterRender)),this.initialized=!0}#t(){let e=this.$matterJsContainer.width(),t=this.$matterJsContainer.height(),n=t+this.#e;return this.tags=this.tagTexts.map((n,r)=>{let i=A(.2*e,.8*e),o=A(.2*t-this.#e,.8*t),a=this.tagColors[r%this.tagColors.length],s=D(i,o,n,a,this.$matterJsContainer,this.mouseDragging);return E.add(this.engine.world,s.body),s}),this.mouseDragging&&I(this.engine,this.$matterJsContainer),E.add(this.engine.world,M(e,t,n,this.#e)),{containerWidth:e,containerHeight:t}}removeObjects(){E.clear(this.engine.world,!1),this.tags.forEach(e=>e.elem.remove()),this.tags=[]}render(){this.initialized||this.init(),this.tags.forEach(e=>e.render()),T.update(this.engine,12),requestAnimationFrame(this.render.bind(this))}#n=/*@__PURE__*/r(k).throttle(()=>{this.removeObjects(),this.$matterJsContainer=/*@__PURE__*/r(s)(this.containerSelector),this.#t(),this.debugPhysics&&(this.matterRender.canvas.height=this.$matterJsContainer.height(),this.matterRender.canvas.width=this.$matterJsContainer.width())},1e3);onWindowResizing(){this.#n()}}const M=(e,t,n,r)=>[P.rectangle(e/2,-r,e,1,{isStatic:!0}),P.rectangle(e/2,t,e,1,{isStatic:!0}),P.rectangle(0,(t-r)/2,1,n,{isStatic:!0}),P.rectangle(e,(t-r)/2,1,n,{isStatic:!0})// right
    ],D=(e,t,n,i,o,a)=>{let u=A(0,1e5);o.append(`<div id="tag${u}" class="interactive-tag tag-24">${n}</div>`);let l=/*@__PURE__*/r(s)("#tag"+u),c=l.height(),f=l.outerWidth();l.css({width:f+"px",padding:0,"background-color":i,cursor:a?"pointer":"default"});let p=Number.parseInt(l.css("border-radius").replace("px","")),d=2*Number.parseInt(l.css("border").replace(/px.*/,""));return{w:f+d,h:c+d,body:P.rectangle(e,t,f+d,c+d,{chamfer:{radius:p}}),elem:document.querySelector("#tag"+u),prevX:C(e),prevY:C(t),render(){let{x:e,y:t}=this.body.position,n=C(e),r=C(t);if(this.prevX===n&&this.prevY===r)return;let i=r-this.h/2;this.elem.style.top=`${i}px`;let o=n-this.w/2;this.elem.style.left=`${o}px`,this.elem.style.transform=`rotate(${this.body.angle}rad)`,this.prevX=n,this.prevY=r}}},I=(e,t)=>{let n=/*@__PURE__*/r(S).MouseConstraint.create(e,{element:t.get(0)}),i=n.mouse;i.element.removeEventListener("mousewheel",i.mousewheel),i.element.removeEventListener("DOMMouseScroll",i.mousewheel),i.element.removeEventListener("touchstart",i.mousedown),i.element.removeEventListener("touchmove",i.mousemove),i.element.removeEventListener("touchend",i.mouseup),i.element.addEventListener("touchstart",i.mousedown,{passive:!0}),i.element.addEventListener("touchmove",e=>{n.body&&i.mousemove(e)}),i.element.addEventListener("touchend",e=>{n.body&&i.mouseup(e)}),E.add(e.world,[n])},B=(()=>{let e=new j(".main-container-content .matter-js-container:visible",["JTBD","User & Market Research","Usability testing","Accessibility","CJM","Qualitative research","UX design","Wireframing","UX research","Quantitative research","Design systems","Problem solving","User centred design","User-Centered Design","Prototyping","Interaction design"],["#B3DDC7","#F9E398","#EB7A53","#C1D8FE"],!0,!1);return e.render(),e})(),R=["#D5B8F0","#C1D8FE","#F9E398","#EB7A53","#B3DDC7"],L=(()=>{let e=new j(".case-1-container .matter-js-container",["Design system","UI design","B2B","Qualitative research","Usability testing","2022"],R);return e.render(),e})(),O=(()=>{let e=new j(".case-2-container .matter-js-container",["Design system","UI design","B2B","Qualitative research","Usability testing","2022"],R);return e.render(),e})(),q=(()=>{let e=new j(".case-3-container .matter-js-container",["Design system","UI design","B2B","Qualitative research","Usability testing","2022"],R);return e.render(),e})();let N=/*@__PURE__*/r(s)(window).width(),H=/*@__PURE__*/r(s)(window).height();/*@__PURE__*/r(s)(window).resize(()=>{(N!==/*@__PURE__*/r(s)(window).width()||H!==/*@__PURE__*/r(s)(window).height())&&(N=/*@__PURE__*/r(s)(window).width(),H=/*@__PURE__*/r(s)(window).height(),B.onWindowResizing(),L.onWindowResizing(),O.onWindowResizing(),q.onWindowResizing())}),("ontouchstart"in window||navigator.maxTouchPoints)&&[".cv-button",".explore-case-studies-button",".link-block",".full-case-link-button",".footer-button"].forEach(e=>{/*@__PURE__*/r(s)(e).each((e,t)=>{let n=/*@__PURE__*/r(s)(t);n.on("click",()=>{n.removeClass("no-hover"),setTimeout(()=>{n.addClass("no-hover")},1e3)})})}),window.matchMedia("(max-width: 600px)").matches||(0===window.scrollY?x.addClass("description-container-margin").removeClass("description-container-margin-scrolled"):x.addClass("description-container-margin-scrolled").removeClass("description-container-margin"));//# sourceMappingURL=index.d8af46ef.js.map

//# sourceMappingURL=index.d8af46ef.js.map
