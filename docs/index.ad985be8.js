...
Ā:"A",Ă:"A",Ą:"A",ā:"a",ă:"a",ą:"a",Ć:"C",Ĉ:"C",Ċ:"C",Č:"C",ć:"c",ĉ:"c",ċ:"c",č:"c",Ď:"D",Đ:"D",ď:"d",đ:"d",Ē:"E",Ĕ:"E",Ė:"E",Ę:"E",Ě:"E",ē:"e",ĕ:"e",ė:"e",ę:"e",ě:"e",Ĝ:"G",Ğ:"G",Ġ:"G",Ģ:"G",ĝ:"g",ğ:"g",ġ:"g",ģ:"g",Ĥ:"H",Ħ:"H",ĥ:"h",ħ:"h",Ĩ:"I",Ī:"I",Ĭ:"I",Į:"I",İ:"I",ĩ:"i",ī:"i",ĭ:"i",į:"i",ı:"i",Ĵ:"J",ĵ:"j",Ķ:"K",ķ:"k",ĸ:"k",Ĺ:"L",Ļ:"L",Ľ:"L",Ŀ:"L",Ł:"L",ĺ:"l",ļ:"l",ľ:"l",ŀ:"l",ł:"l",Ń:"N",Ņ:"N",Ň:"N",Ŋ:"N",ń:"n",ņ:"n",ň:"n",ŋ:"n",Ō:"O",Ŏ:"O",Ő:"O",ō:"o",ŏ:"o",ő:"o",Ŕ:"R",Ŗ:"R",Ř:"R",ŕ:"r",ŗ:"r",ř:"r",Ś:"S",Ŝ:"S",Ş:"S",Š:"S",ś:"s",ŝ:"s",ş:"s",š:"s",Ţ:"T",Ť:"T",Ŧ:"T",ţ:"t",ť:"t",ŧ:"t",Ũ:"U",Ū:"U",Ŭ:"U",Ů:"U",Ű:"U",Ų:"U",ũ:"u",ū:"u",ŭ:"u",ů:"u",ű:"u",ų:"u",Ŵ:"W",ŵ:"w",Ŷ:"Y",ŷ:"y",Ÿ:"Y",Ź:"Z",Ż:"Z",Ž:"Z",ź:"z",ż:"z",ž:"z",Ĳ:"IJ",ĳ:"ij",Œ:"Oe",œ:"oe",ŉ:"'n",ſ:"s"}),tO=tk({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"});/**
   ...
   */var tX=tk({"&amp;":"&","&lt;":"<","&gt;":">","&quot;":'"',"&#39;":"'"}),tG=function e(t){/** Built-in constructor references. */var n,K,eg,ey,em=(t=null==t?e3:tG.defaults(e3.Object(),t,tG.pick(e3,eY))).Array,ex=t.Date,eb=t.Error,ew=t.Function,e_=t.Math,eS=t.Object,eA=t.RegExp,eC=t.String,ek=t.TypeError,eT=em.prototype,eE=ew.prototype,eP=eS.prototype,ej=t["__core-js_shared__"],eM=eE.toString,eD=eP.hasOwnProperty,eR=0,eI=(n=/[^.]+$/.exec(ej&&ej.keys&&ej.keys.IE_PROTO||""))?"Symbol(src)_1."+n:"",eB=eP.toString,eL=eM.call(eS),eO=e3._,eH=eA("^"+eM.call(eD).replace(J,"\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g,"$1.*?")+"$"),eN=e6?t.Buffer:r,eq=t.Symbol,Uint8Array=t.Uint8Array,eF=eN?eN.allocUnsafe:r,eW=tF(eS.getPrototypeOf,eS),e$=eS.create,eX=eP.propertyIsEnumerable,eK=eT.splice,e2=eq?eq.isConcatSpreadable:r,e5=eq?eq.iterator:r,e4=eq?eq.toStringTag:r,e9=function(){try{var e=is(eS,"defineProperty");return e({},"",{}),e}catch(e){}}(),e8=t.clearTimeout!==e3.clearTimeout&&t.clearTimeout,e7=ex&&ex.now!==e3.Date.now&&ex.now,tm=t.setTimeout!==e3.setTimeout&&t.setTimeout,tk=e_.ceil,tY=e_.floor,tJ=eS.getOwnPropertySymbols,tQ=eN?eN.isBuffer:r,tZ=t.isFinite,tK=eT.join,t0=tF(eS.keys,eS),t1=e_.max,t2=e_.min,t5=ex.now,t3=t.parseInt,t4=e_.random,t9=eT.reverse,DataView=is(t,"DataView"),Map=is(t,"Map"),Promise=is(t,"Promise"),Set=is(t,"Set"),WeakMap=is(t,"WeakMap"),t6=is(eS,"create"),t8=WeakMap&&new WeakMap,t7={},ne=iR(DataView),nt=iR(Map),nn=iR(Promise),nr=iR(Set),ni=iR(WeakMap),no=eq?eq.prototype:r,na=no?no.valueOf:r,ns=no?no.toString:r;/*------------------------------------------------------------------------*//**
     ...
     */function nm(e,t){var n=oP(e),r=!n&&oE(e),i=!n&&!r&&oR(e),o=!n&&!r&&!i&&oG(e),a=n||r||i||o,s=a?tP(e.length,eC):[],u=s.length;for(var l in e)(t||eD.call(e,l))&&!(a&&// Safari 9 has enumerable `arguments.length` in strict mode.
...
ny.prototype.clear=/**
     ...
     */function(e,t,n,i,o,a){var s=oP(e),u=oP(t),l=s?f:ic(e),v=u?f:ic(t);l=l==c?x:l,v=v==c?x:v;var g=l==x,b=v==x,C=l==v;if(C&&oR(e)){if(!oR(t))return!1;s=!0,g=!1}if(C&&!g)return a||(a=new ny),s||oG(e)?r9(e,t,n,i,o,a):/**
...
"function"==typeof e?e:null==e?aD:"object"==typeof e?oP(e)?n9(e[0],e[1]):n4(e):aF(e))}/**
     ...
     * @param {Object} [stack] Tracks traversed source values and their merged
     *  counterparts.
     */(function(e,t,n,i,o,a,s){var u=iA(e,n),l=iA(t,n),c=s.get(l);if(c){nb(e,n,c);return}var f=a?a(u,l,n+"",e,t,s):r,p=f===r;if(p){var d=oP(l),h=!d&&oR(l),v=!d&&!h&&oG(l);f=l,d||h||v?oP(u)?f=u:oD(u)?f=rI(u):h?(p=!1,f=rE(l,!0)):v?(p=!1,f=rj(l,!0)):f=[]:oU(l)||oE(l)?(f=u,oE(u)?f=o2(u):(!oN(u)||oL(u))&&(f=id(l))):p=!1}p&&(// Recursively merge objects and arrays (susceptible to call stack limits).
...
if("string"==typeof e)return e;if(oP(e))return td(e,rv)+"";if(oX(e))return ns?ns.call(e):"";var t=e+"";return"0"==t&&1/e==-s?"-0":t}/**
...
if(h){if(!ty(t,function(e,t){if(!tR(h,t)&&(v===e||o(v,e,n,i,a)))return h.push(t)})){d=!1;break}}else if(!(v===g||o(v,g,n,i,a))){d=!1;break}}return a.delete(e),a.delete(t),d}/**
     ...
     */function iy(e,t){if(oP(e))return!1;var n=typeof e;return!!("number"==n||"symbol"==n||"boolean"==n||null==e||oX(e))||G.test(e)||!X.test(e)||null!=t&&e in eS(t)}/**
...
ox.Cache=nv;/**
     ...
     * _.gt(1, 3);
     * // => false
     */var ok=rQ(nz),oT=rQ(function(e,t){return e>=t}),oE=nQ(function(){return arguments}())?nQ:function(e){return oq(e)&&eD.call(e,"callee")&&!eX.call(e,"callee")},oP=em.isArray,oj=te?tM(te):/**
...
nu.after=/*------------------------------------------------------------------------*//**
     ...
     * _.toPath('a[0].b.c');
     * // => ['a', '0', 'b', 'c']
     */function(e){return oP(e)?td(e,iD):oX(e)?[e]:rI(iM(o5(e)))},nu.toPlainObject=o2,nu.transform=/**
     ...
     * }, {});
     * // => { '1': ['a', 'c'], '2': ['b'] }
     */function(e,t,n){var r=oP(e),i=r||oR(e)||oG(e);if(t=ii(t,4),null==n){var o=e&&e.constructor;n=i?r?new o:[]:oN(e)&&oL(o)?nl(eW(e)):{}}return(i?tu:nq)(e,function(e,r,i){return t(n,e,r,i)}),n},nu.unary=/**
...
nu.add=az,nu.attempt=aT,nu.camelCase=ag,nu.capitalize=ay,nu.ceil=aX,nu.clamp=/*------------------------------------------------------------------------*//**
     ...
     * _.isEmpty({ 'a': 1 });
     * // => false
     */function(e){if(null==e)return!0;if(oM(e)&&(oP(e)||"string"==typeof e||"function"==typeof e.splice||oR(e)||oG(e)||oE(e)))return!e.length;var t=ic(e);if(t==y||t==_)return!e.size;if(ib(e))return!n2(e).length;for(var n in e)if(eD.call(e,n))return!1;return!0},nu.isEqual=/**
...
needsContext:RegExp("^"+P+"*[>+~]|:(even|odd|eq|gt|lt|nth|first|last)(?:\\("+P+"*((?:-\\d)?\\d*)"+P+"*\\)|)(?=[^-]|$)","i")},$=/^(?:input|select|textarea|button)$/i,z=/^h\d$/i,X=/^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/,G=/[+~]/,// https://www.w3.org/TR/CSS21/syndata.html#escaped-characters
...
var X=D*_-R*w,G=I*_-B*w,Y=T/(E+y.inverseInertia*X*X+m.inverseInertia*G*G),J=(1+v.restitution)*W*Y;// handle high velocity and resting collisions separately
